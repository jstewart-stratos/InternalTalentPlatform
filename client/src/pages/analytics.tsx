              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm font-medium text-muted-foreground">Total Skills & Expertise</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600 mb-2">
                      {stats.individualSkills.toLocaleString()}
                    </div>
                    <div className="text-sm font-medium text-muted-foreground">Individual Employee Skills</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600 mb-2">
                      {stats.teamExpertise.toLocaleString()}
                    </div>
                    <div className="text-sm font-medium text-muted-foreground">Team Specialties</div>
                  </div>
                </div>
              </CardContent>
            </Card>
